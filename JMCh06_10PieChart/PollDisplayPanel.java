...
public class PollDisplayPanel extends JPanel
{
    ...
    private void drawPieChart( Graphics g, int x, int y, int r )
    {
        ...
        int fromDegree = 0;
        System.out.println("drawPieChart total  = " + total + " Count1 " + count1 + " Count2 " + count2 + " Count3 " + count3);
        if ( total > 0 )
        {
            int degrees;
            System.out.println("fd " + fromDegree);
            ...
            System.out.println(fromDegree + " degree " + degrees);
            fromDegree += degrees;
    ...
    private void drawLegend( Graphics g, int x, int y, int r )
    {
        ...
        g.drawString( String.valueOf(count2), x, y );
        g.drawString( String.valueOf(count3), x + r, y );
    ...
    {
        //Returns convert degrees to double, added 0.5 to round return value
        double rtn = ((double)count/total) * 360;
        return (int)(rtn + 0.5 );
    }
