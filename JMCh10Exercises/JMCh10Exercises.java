...
public class JMCh10Exercises
{
    ...
    {
        int value = name.indexOf(",") - 1; 
        String s2 = name.substring(0, value);
        String s3 = name.substring(value, name.length());
        String s4 = s2 + s3;

        return s4.trim(); // FIX THIS!!!
    }
